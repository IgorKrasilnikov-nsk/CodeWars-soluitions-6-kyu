...
function AlanAnnoyingKid(input) {
  let str = input.slice(8, input.length - 1);
  let arr = str.split(" ");
   
  if (arr[0] == "didn't") {
    return "I don't think you " + str + " today, I think you did " + arr[1] + " it!"
  } else {
    return "I don't think you " + str + " today, I think you didn't " + arr[0].slice(0,arr[0].length - 2) + " at all!"
  }	
}
