...
function unusualSort(arrayOfChars){
  return arrayOfChars.sort((a, b) => {
    const aIsDigit = !isNaN(a) && a !== ' ';
    const bIsDigit = !isNaN(b) && b !== ' ';
...
console.log(unusualSort([3,"3","2",2,"2","1",1,"a","b","c"])); // ["a","b","c",1,"1",2,"2","2",3,"3"]
console.log(unusualSort(['c', 'b', 'a', '9', '5', '0', 'X', 'Y', 'Z'])); // ['X', 'Y', 'Z', 'a', 'b', 'c', '0', '5', '9']
