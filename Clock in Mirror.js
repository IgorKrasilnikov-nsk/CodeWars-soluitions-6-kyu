...
function WhatIsTheTime(timeInMirror) {
  ...
  let mirrorMin = (60 - minutes) % 60;
  let mirrorHours = (12 - hours - (minutes === 0 ? 0 : 1) + 12) % 12;
    
  if (mirrorHours === 0) mirrorHours = 12;
  
  return `${String(mirrorHours).padStart(2, '0')}:${String(mirrorMin).padStart(2, '0')}`;
}
