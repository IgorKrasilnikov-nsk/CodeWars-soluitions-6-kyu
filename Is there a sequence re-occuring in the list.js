/*
You are given a list of items (characters and/or integers). Find if an item reoccurs after a break of its sequence (see explanation below). 
In other words: are there any items that reoccur in the list, but separated by one or more different items?
...
console.log(isReoccuring([0,0,1,0,0]));   // true
console.log(isReoccuring([0,0,1,1,2,2,1,1]));   // true
console.log(isReoccuring([0, 0, 0]));   // false
console.log(isReoccuring([0,0,1,1,2,2]));   // false
